/*
 * GoogleStorageFacade contains all implementation details of functionalities related with 
 * Google Cloud Storage service.
 * Following are the functionalities in this class:
 * 			1. getProperties()
 * 			2. getStorage()
 * 			3. createBucket()
 * 			4. uploadFile()
 ...
 */
public class GoogleStorageFacade {
	...
	private static Properties getProperties() throws Exception {
		...
		if (properties == null) {
			...
			InputStream stream = GoogleStorageFacade.class
